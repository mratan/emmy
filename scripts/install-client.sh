...
# ----------------------------------------------------------------------------
# Phase 04.2 expands remote-client mode from "inference only" to "inference +
# sidecar control + web_search". The Mac wrapper assumes 3 Tailscale Serve
# routes (vLLM 8002, sidecar 8003, SearxNG 8888) plus the always-on systemd
# user unit for the sidecar. The reminders below print the exact one-time
# Spark-side ops the operator must run for the Mac wrapper to work end-to-end.
